    ...
    return (
        ...
        <form action="" method="post" className="p-3" onSubmit={(e)=>{
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-6">
                ...
                <input type="text" name="username" id="username" className='col-span-2 w-[100%] outline-none px-4 rounded-lg border border-[gray] bg-light-colors-login-third-bg dark:border-[#374558] dark:bg-dark-colors-login-third-bg'/>
                <label htmlFor="_password">Password</label>
                <input type="text" name="_password" id="password"  className='col-span-2 w-[100%] outline-none px-4 rounded-lg border border-[gray] bg-light-colors-login-third-bg dark:border-[#374558] dark:bg-dark-colors-login-third-bg'/>
                ...
                <select name="role" className="w-fit outline-none px-4 rounded-lg border border-[gray] bg-light-colors-login-third-bg dark:border-[#374558] dark:bg-dark-colors-login-third-bg">
