...
interface RequestAddFormProps {
    className?: string;
    refresh:object;
    setRefresh:React.Dispatch<React.SetStateAction<object>>;
...
const RequestAddForm: FC<RequestAddFormProps> = ({className ,refresh, setRefresh}) => {
    ...
    return (
        <Container className={`${className}`}>
            ...
            <form action="" method="post" className='flex flex-col gap-4' onSubmit={e=>{onSubmitRequest(e,lang,setLoading , setRefresh,refresh)}}>
